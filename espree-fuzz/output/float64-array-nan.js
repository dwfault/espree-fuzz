...
if (o3()) {
    test(0xFFFF0000, 'Error is expected. Expected "', 0/0);
    test(0, 0xFFFF0000, 1);
} else {
    test("{ assert(boo(), 'undefined'); delete a; assert(boo(), 'undefined'); function a() { return 'text-a'; } assert(boo(), 'function');} ", 0, 1);
