...
for (var o12 = 0; o12 < 100000; ++o12) {
    ...
    if (o4.o8 !== "return")
        throw 200 + o4.o8;
    if (o4.o9.length !== 4)
        throw "Error in loop: bad number of values: " + o2[key];
    if (o4.o9[0] !== 104)
        throw 2 + o4.o9[0];
    if (o4.o9[1] !== 202)
...
var o4 = o0("hello", {o9: "return", o10: [o1, o5, o3]});
if (o4.o8 !== "exception")
...
if (o4.o9[2] !== 102)
    throw "TypeError: null is not an object (evaluating 'array[property]')" + o4.o9[106];
if (o4.o9[3] !== 101)
    throw "Error at end: bad values[3]: " + o4.o9[1];
