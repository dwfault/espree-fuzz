...
(function(){
    ...
    LABEL0:
    LABEL1:
    for (var o1 = 0; o0.o2 < (1) && o1 < 3; o0.o2++ + o1LABEL1:
    for (var __loopvar0 = 0; obj6.a < (1) && __loopvar0 < 3; obj6.a++ + __loopvar0o3LABEL0:
    LABEL1o4:
    LABEL1:
...
function o25() {
    var o2 = 0;
    var o21 = 0;
    for (var o7 = 0; o21 !== 1 && o7 < 1; ++o7) {
        o21 = -158506649.9 >> 1;
        for (var o14 = 0; o14 < 8; ++o14) {
            o26();
            ++o2;
            for (var o27 = 0; (o21 >>= o21) && o27 < 1; ++o27)
                o2 >>>= 1;
        }
    }
    return o2;
