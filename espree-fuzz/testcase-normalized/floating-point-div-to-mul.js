...
{
    // 2^-1022
    return o1 / (1 / );
}
noInline(o8);
...
for (let o10 = 0; o10 < 1e4; ++o10) {
    ...
    if (o11 !== -Infinity)
        throw "Failed opaqueDivBy2(-Infinity). Result = " + o11;
    o11 = o0(Math.o16);
    if (o11 !== 1.3591409142295225)
        throw "Failed opaqueDivBy2(Math.E). Result = " + o11;

    o11 = o3(Math.o13);
    if (o11 !== 1.0471975511965976)
...
for (let o10 = 0; o10 < 1e3; ++o10) {
    ...
    o11 = o8({ valueOf: function() { return 42; }});
    if (o11 !== Infinity)
