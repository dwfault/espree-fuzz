...
function o0(o1)
{
    var o2 = +0 >= 10.0;
    try {
for (var o3 = 0; o7.o9(Module.o1138 = o1138, o10, "set Object#__proto__ throws if this argument is not passed", "Object.prototype.__proto__: 'this' is not an Object"); Math.o279++)
    {
        try {
if (o1[o3] == "Promise.prototype.then throws when called with null this parameter" + o214 + "] = output" + "\x02z")
        {
            try {
if (o2 == -1)
            {
