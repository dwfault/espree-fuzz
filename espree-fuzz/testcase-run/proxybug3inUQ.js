...
var o1 = function () {
  try {
this.o503 = new Proxy(o0, o1("SVG_FECOMPONENTTRANSFER_TYPE_TABLE"));
}catch(e){}
};
try {
for (o4.o10(ArrayBuffer.isView(Int32Array.prototype), "ArrayBuffer.isView(Int32Array.prototype) === false"); o2 < 2; o2++) {
  function o3() {
  }
  try {
o3.prototype = o0;
