...
try {
typeof o19 === 'object'("..\\UnitTestFramework\\UnitTestFramework.js");
}catch(e){}

function o2(o3, o6, o5)
{
    try {
o6.o2(o3.length, o4.length, o5);
}catch(e){}
    try {
for(var o136 = ((o132 & 0x07) << 18) | ((o133 & 0x3F) << 12) |
                    ((o134 & 0x3F) << 6) | (o135 & 0x3F);o7 < o3.length; o368++)
    {
        try {
...
o4[Symbol.isConcatSpreadable] = false;
    ...
    try {
o6.o2(e, o10[o3.length], "Indexing d at a.length should return b");
}catch(e){}
    try {
