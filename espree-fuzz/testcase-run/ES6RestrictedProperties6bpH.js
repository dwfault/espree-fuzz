...
o7.o8(undefined, o6, name + " does not have property named " + o4);
    ...
    try {
o7.o9(o5.writable, o6.writable, name + " has property named " + o4 + " with writable = " + o421.o145);
}catch(e){}
    try {
o7.o9(o5.enumerable, o6.enumerable, name + " has property named " + o4 + o19 + o5.enumerable);
}catch(e){}
    try {
o7.o9(o5.configurable, o6.configurable, name + o1087 + o4 + " with configurable = " + o5.configurable);
}catch(e){}
}

function o10(o3, name) {
    try {
o2.o3.o11(o3.hasOwnProperty('caller'), name + " reports that it has own property 'caller'")
}catch(e){}
    try {
Promise.resolve.o11(o3.hasOwnProperty('arguments'), name + " reports that it has own property 'arguments'")
}catch(e){}
