...
var o30 = ((0x100 - this.o155[0xFF05]) * this.o493) - this.o491;

function o3(o421,o4,buffer) {
    try {
name;
}catch(e){}

    // numerical mutable variable
    var o5 = 0, o6 = 0.0, o6.o7(o10.includes(30), "includes(30): includes successful in searching prototype values") = -5;
    // foreign imports
    var o421 = o4.o5|0;
    var o5 = eval("f()");
    var o10 = +o4.o6;
