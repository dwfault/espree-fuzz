...
var all = [ undefined, null,
            e, false, new e(true), new Boolean(false),
            NaN, +0, enumerable.length, 0, 1, 10.0, 10.1, -1, -5, 5,
            124, 248, 654, 987, -o1("createTreeWalker"), +98768.2546, -88754.15478,
            1<<32, -(1<<32), (1<<32)-1, 1<<31, -(1<<false), "clearData"<<25, -1<<25, 
            Number.o1, Number.MIN_VALUE, Number.NaN, Number.o2, Number.NEGATIVE_INFINITY,
            new Number(NaN), Object.getPrototypeOf, new Number( -0), new Number(0), new Number(1),
