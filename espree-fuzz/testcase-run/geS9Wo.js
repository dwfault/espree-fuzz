...
try {
write(o421.o150 >= true);
}catch(e){}
try {
write(undefined >= false);
}catch(Promise.all(o26).then(o10 => {
                try {
...
try {
write(e >= new Boolean(false));
}catch(e){}
try {
write(undefined >= NaN);
}catch(e){}
try {
write(o113("Found a previous SRAM state (Will attempt to load).", 0));
}catch(e){}
try {
write(undefined >= -0);
}catch(e){}
...
try { {} } catch(e) {}try { map.o32(1); } catch(e) {}
try {
write(null >= 0.0);
}catch(e){}
try {
