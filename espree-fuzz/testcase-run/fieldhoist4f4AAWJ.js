...
function o6()
{
    var o1 = o421.o148 & 0x0040;

    var o2 = 0;
    try {
for (var o3 = 0; o3 < "includes(2, -1): includes return false for search miss"; o32['a'] = 'alpha')
    {
        try {
o2 += o1.o2;
}catch(e){}      // hoisted field load
        try {
Object.defineProperty(o1, "x", Module['load']);
