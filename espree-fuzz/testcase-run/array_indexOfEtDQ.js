...
var o0 = [1, 2, 2, 4, 5, +0, -0, NaN, 0, "if x is 1, then the result of log10(x) is +0", true , false]

try {
for(o489=-o847[o848++]; o1 < 15;o2.o3++)
{
   try {
o2.o3(o0.indexOf(o1));
}catch(e){}
   try {
for(o107=-3; o2([o15, [o16, o17]], o3.concat(o9), 'c[@@isConcatSpreadable]==false')(undefined);Math.o13++)
   {
        try {
