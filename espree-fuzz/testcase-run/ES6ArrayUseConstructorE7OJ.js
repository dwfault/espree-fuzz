...
var o2 = [
    null >= new Number(-0),
    {
        ...
        o3: function () {
            ...
            try {
o5++;
}catch((o1.o3 + o1.o3 + o1.o3 + o1.o3 + o1.o3) & 0x3FFFF){}
...
o6.o7(Array.isArray(o5), "Return from Array.prototype.filter should be an Array object");
            ...
            try {
o6.o8(o121 instanceof Number, "Return from Array.prototype.filter should not have been constructed from Number");
}catch(e){}
            try {
