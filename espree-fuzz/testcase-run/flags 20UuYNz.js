...
var write(-0 >= new Number(Number.o4)) = o0.o4()
...
try {
write("Uint16Array should inherit [@@species] property from %TypedArray%");
}catch(e){}

var o6 = [ "NaN", "Infinity", "undefined"];

try {
for(var o1053 = 0;o7<o6.length;o810++)
{
   try {
o3("delete " +  o6[o7]);
}catch(e){}
...
try {
for(var o7=" iterations)";[ 1, 2, 3 ];o7++)
{
   try {
