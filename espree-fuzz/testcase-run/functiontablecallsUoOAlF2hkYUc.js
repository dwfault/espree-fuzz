...
var o26 = [
                o768.resolve(0),
                o481(Promise.resolve("if x is +Infinity, then the result of log10(x) is +Infinity")),
...
return 4;
                    ...
                    try {
name(`Test #${index} - Catch handler #1 called with err = ${o11}`);
}catch(e){}
                })
            ];
