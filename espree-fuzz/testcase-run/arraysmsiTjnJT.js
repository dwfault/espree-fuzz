...
var o596 = (o421.o816 + (o1059 | 0) == (o259[o1043 >> 2] | 0)) & 0xFFFF;
...
var o8=o360.prototype.o793 = function () {try {
"use strict";
}catch(e){}
  try {
if (o479.o503.o535 == 0) {
...
try {
o1(o8.length,536870912,o12.o4.o11(3, Float32Array.length, "Float32Array.length === 3"), "\"Testing Array of length 2^29 \"");
}catch(e){}
...
try {
Object(o31.o4, 536870913, o421.o143++,"\"Testing Array of length 2^29+1 \"");
}catch(e){}

// Test Case 3:Testing an array of length 2^29 -1 (One less than the max length of the tagged integer)

var o10=new o560(o0.o4(function () { try {
