...
var Promise.prototype.catch.call = (1024 * 1024) & 0xFFFF;
...
var o8=o421 = 0
try {
o1(o8.length,536870912,o12.findIndex, "\"Testing Array of length 2^29 \"");
}catch(e){}

// Test Case 2:Testing Array of length 2^29+1(One more than the max length of the tagged integer)

var o421.o412 = new Promise(function(resolve,reject) {
                try {
reject('success');
}catch(e){}
                try {
...
try {
o1(o31.o4, 536870913, this.o393[0x68]++,"\"Testing Array of length 2^29+1 \"");
}catch(e){}
