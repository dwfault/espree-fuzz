...
o5.o6('something', o4.name, "new target() returned our new object instead of new.target");
    ...
    },
    {
        ...
        o3: function() {
            try {
o5.o7(ArrayBuffer.prototype.slice, "new.target one level block do not throw in a function");
}catch(e){}
            try {
o5.o7(function(){{{try {
new.target;
...
o15.o16();
    ...
    { o26: (o16[((o0 ? (o16[1] = 'x') : undefined), 1)], 1, 1, 1), o27: 1 },
    {
