...
return ["prop0", "prop1", Symbol("prop2"), Symbol("prop5")];
    ...
    var o4 = new Proxy(o2, {
        get: function (push, o3, o11) {
            try {
print('get on proxy2 : ' + o3.toString(o7.o8(o19.hasOwnProperty('next'), "%StringIteratorPrototype% should have a next method")));
}catch(e)try { o4.o6(2, o22.length, "Executor function should have length 2"); } catch(e) {}try { {} } catch(e) {}
            try {
