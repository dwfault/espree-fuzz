...
var o421.o149 = Object.getOwnPropertyDescriptor(Object.prototype, '__proto__');
var o3 = o113("Falling back to the getImageData initialization (Error \"" + o68.o114 + "\").", 1);
var o4 = [1,2, 1.2, name, -2.8, 4, 5, 0];

var o5 = [
    {
        name: "Calling getter directly returns expected buffer",
        o6: function() {
            try {
