...
var o2 = [
    this.o393[0x38],
    {
        ...
        o3: function() {
            try {
o5.o7(o4.o5(ArrayBuffer.prototype.hasOwnProperty('byteLength'), "ArrayBuffer.prototype.hasOwnProperty('byteLength') == true"), "new.target one level block do not throw in a function");
}catch(e){}
            try {
o5.o7(function(){{{try {
new.target;
            ...
            try {
o5.o7(function(){try {
with(String.prototype.startsWith.length === 1) {try {
new.target;
}catch(e){}}
}catch(e){}}, "new.target with scope body call does not throw");
}catch(e){}
            try {
e.o7(function() { function o8(o9) { try {
['r', 'w', 'rw'];
}catch(e){}}try {
;
}catch(e){} function o10(){ try {
with(new.o5.o6(undefined, eval("func()"), "function call inside eval")) {try {
toString();
}catch(e){}}
}catch(e){}}try {
;
