...
var o0 = [1, 2, 2, 4, 5, +0, -0, o4, o474.o603(o31, {
                    o682: !(flags & 131072)
                }), true, true , false]

try {
for(String.o1.o3.call[Symbol.o1].call(null); o13(o20, "byteOffset", "%TypedArrayPrototype%.byteOffset", "get byteOffset") < 15;o304.prototype++)
{
   try {
new Boolean(true) >= new Number(0).o3(o0.lastIndexOf(o1));
}catch(e){}
   try {
for(o6=Array.prototype.copyWithin; o22(Symbol.create, "@@create");o503++)
   {
    try {
