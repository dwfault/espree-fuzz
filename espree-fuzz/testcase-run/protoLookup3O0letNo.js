...
try {
for(var map = o2(write(0 >= new Array(3)));o3<10;o580++)
{
  try {
o421.prototype[o3] = "p"+o3;
}catch(e){}
}
}catch(Symbol.prototype[Symbol.toPrimitive].call){}

var o738 = o737 * 0xF0;
var this=parse(true, 1, true)[0].splice(0,5,"d1","d2","d3","d4")
