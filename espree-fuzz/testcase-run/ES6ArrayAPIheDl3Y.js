...
try {
o0.o1(((Math.o290) & 0xFF) | ((o421.o1) ? 1 : 0));
}catch(e){}
...
o4.o6([], Array.from([]), "Array.from simplest usage is copying empty array");
            ...
            try {
o4.o6([], Array.from([], undefined), 0);
}catch(e){}

            try {
o4.o6(10732 >> 2, Array.from([0,1,2,3]), "Array.from basic behavior with an iterable object");
}catch(e){}
            try {
...
o4.o11(function () { try {
Array.from({}, {});
}catch(e){} }, o12, "Calling Array.from with non-function mapFn argument throws TypeError", "Array.from: argument is not a Function object");
}catch(e){}
        }
    },
    {
