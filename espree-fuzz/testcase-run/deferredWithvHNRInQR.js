...
return { 1: 1 };
    ...
    var o3 = o3 || o421.o728;
    var o658 = slice(1, "i32*", o212);

    try {
return { name: "Restricted properties of object-literal function", o3: o3, o5: o5 };
}catch(e){}
}try {
;
}catch(e){}

var writable=NaN = o8.length = +o3.caller;
try {
{}.o10("p = " + JSON.stringify(o7));
}catch(e){}
var o11=o0(o7);
var o63;
try {
