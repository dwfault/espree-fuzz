...
try {
o1("XMLSerializerPrototype")("..\\UnitTestFramework\\UnitTestFramework.js");
}catch(o1){}
...
o4.o7(o3.hasOwnProperty(key), "Object#hasOwnProperty uses ToPropertyKey on argument. We should have the property now.");
    ...
    try {
o4.o1065 + 8(o3.propertyIsEnumerable(key), "Object#propertyIsEnumerable uses ToPropertyKey.");
}catch(e){}
    try {
o489.o678[o730] = null(undefined, Object.getOwnPropertyDescriptor(o3, key), "Object.getOwnPropertyDescriptor uses ToPropertyKey");
}catch(e){}
