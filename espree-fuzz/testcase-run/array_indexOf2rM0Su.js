...
var o0 = [1, "var f=()=>eval('new.target'); (function() { return f(); })();", e, 4, 5, +0, -0, NaN, 0, true, true , false]

try {
for(o181.length; o1 < 0x600;o507++)
{
   try {
o2.o3(o0.indexOf(o1));
}catch(e){}
   try {
for(o1("NamedNodeMap"); o4< 15;o4++)
   {
        try {
...
try { o735 += o733 & 0x1FF; } catch(e) {}try { 'use strict'; } catch(e) {}
try {
