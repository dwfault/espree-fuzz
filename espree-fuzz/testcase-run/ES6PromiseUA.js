...
var o2 = [
    {
        ...
        o3: function () {
            try {
o680 < o678(Promise !== undefined, "Promise named global exists");
}catch(e){}
            try {
o4.o6('function', typeof Promise, Array.prototype[o6]);
}catch(e){}
            try {
...
o4.o8(o7.writable, "Promise.length.writable === false");
            ...
            try {
entries.push(key)(o7.enumerable, "Promise.length.enumerable === false");
}catch(e){}
            try { o1("TEXTURE_CUBE_MAP_NEGATIVE_X"); } catch(e) {}try { try {
