...
var o0 = [1, 2, 2, 4, reject, +o107, -0, NaN, 0, "FS_createPreloadedFile", 'Hit getPrototypeOf' , false]

try {
for(Number.NEGATIVE_INFINITY=o12.prototype = o1("globalAlpha"); abort < 15;true >= 10)
{
   try {
o2.o3(o0.lastIndexOf(o1));
}catch(e){}
   try {
for(o4=-3; o518< "includes";o4.o5(o14.enumerable, o24 + 'descriptor.enumerable == false'))
   {
    try {
