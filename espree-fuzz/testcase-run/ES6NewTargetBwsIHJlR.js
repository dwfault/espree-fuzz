...
o5.o17(function() { try {
return new['target'];
}catch(new o20()){} }, o18, "Meta-property new.target is not a real property lookup", "Object doesn't support this action");
}catch(e){}
            try {
o5.o108(function() { try {
return eval('new.');
