...
class o1{
  ...
  constructoro4.o7(o32[o42] !== 'gamma', "for ... in does not enumerate properties keyed by symbols")

};
try {
try { {
for (let o2 = 0; o2 < 100; o2++) {
    try {
o0();
}catch(e){}
}
...
test.o6 = function(o1, o2)
{
    ...
    var o4 = 0;
    try {
for (var keys = [ 1, 2, 1, 2, 1, 2, 1, 2, 1, 2 ]; o5 < 10000; o259[10720 >> 2]++)
    {
        try {
o3 = o360.prototype;
}catch(e){}
