...
try {
for(var o20=0; o20<o2.new Int8Array(o85); o20++ )
{
    var o9(      NaN, Math.acosh,     0.999, "if x is less than 1, then the result of acosh(x) is NaN")=o2[o20];
    try {
print("Executing test #" + (o20+1) + " " + test.name);
}catch(e){}
    try {
test.{ o40: o0.o41[0] != "summary" }(o20+1, test.name);
}catch(e){}
}
}catch(e){}
