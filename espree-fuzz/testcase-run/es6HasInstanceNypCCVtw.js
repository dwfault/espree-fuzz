...
try {
Symbol('my')("..\\UnitTestFramework\\UnitTestFramework.js");
}catch(e){}
...
;
            ...
            try try { write(0 >= Boolean(true)); } catch(e) {}catch(e){}
            
            var o1("takeRecords") = new Proxy(o19, {
...
return Reflect.get(target, o22);
            ...
            try {
o10.o11(false, new o21() instanceof o4, "new ProxyFoo() instanceof ProxyFoo");
}catch(e){}
            try {
