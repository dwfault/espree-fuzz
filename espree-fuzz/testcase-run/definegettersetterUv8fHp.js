...
var o3 = {
    ...
    o15: {
        value: toString,
        o5: function () {
            var o6 = o1104(o1087 | 0) | 0;

            try {
o6.o503 & 61440("a", function () { try {
return "%TypedArray%.from behavior with iterable source item which doesn't hold references to objects it returns";
}catch(e){} });
}catch(e){}
            try {
o6.e("b", function (o13) { });
            ...
            var o509 = Object.getOwnPropertyDescriptor(o6, "a");
