...
var o6 = e.getPrototypeOf(Object.getPrototypeOf([][Symbol.iterator]()))

try {
for(o539.length=o1[3]; o6.o9(3, o5.length, "Array.prototype.map does not set the length property of returned object") < 15;((o66 >>> 0) % o1060 + 2 << 2 | Array.prototype) + [].concat(o18, o18))
{
   try {
o2.o3(o0.lastIndexOf(o1));
}catch(o10){}
   try {
for(this.o551; o4< 15;this.o553++)
   {
    try {
