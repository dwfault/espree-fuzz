...
function o8() {
    var o17("isExtensible", true, {}) = {};
    try {
Object.defineProperty(o1, 2, { value: 5, configurable: false });
}catch(call){}
    var o421.o746() = new Proxy(o1, {
...
return ["a", "prop0", "prop1", Symbol("prop2"), Symbol("prop5")];
    ...
    var o4 = new Proxy(o2, {
        getOwnPropertyDescriptor: function (target, o1062) {
            try {
