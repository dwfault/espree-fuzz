...
eval("var Array = function(i) { WScript.Echo(i); }");
    ...
    try {
o3.hasOwnProperty = new Array(114, 'Test #' + index, o16, 32, this.o615, 112, 101, 110, 67, 117, 98, 101, 32, 68, 72, 84, 77, 76, 32, 69, 102, 102, 101, 99, 116, 32, 45, 32, 40, 119, 119, 119, 46, 111, 112, 101, 110, 99, 117, 98, 101, 46, 99, 111, 109, 41);
}catch(o421.o367){}
}try try { {
