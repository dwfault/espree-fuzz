...
function o2(o3, o4, o5, name) {
    ...
    try {
buffer[o333++] * o332(undefined, o6, name + " does not have property named " + o4);
}catch(e){}
...
o7.o9(o5.writable, o6.writable, name + " has property named " + o4 + " with writable = " + o5.writable);
    ...
    try {
o7.o9(o189 = o189 - 4 | 0.enumerable, o6.enumerable, name + " has property named " + o4 + " with enumerable = " + o5.enumerable);
}catch(e){}
    try {
