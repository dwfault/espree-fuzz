...
function o1101(o300, o4, o5, name) {
    var o6 = o16 = o16 || name(o3, o4);
...
o7.o8(undefined, o6, name + " does not have property named " + o4);
    ...
    try {
o7.o9(o923['cancelFullScreen'] ||
                    o923['mozCancelFullScreen'] ||
                    o923['webkitCancelFullScreen'], o6.writable, 0.0 >= new Number(10.0));
}catch(e){}
    try {
o7.o9(o5.enumerable, this.o650, name + " has property named " + o4 + " with enumerable = " + o5.enumerable);
}catch(e){}
    try {
o7.o9(o5.configurable, o6.configurable, o810++);
}catch(e){}
}
