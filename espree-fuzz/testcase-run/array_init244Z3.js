...
eval("var Array = function(i) { WScript.Echo(i); }");
    ...
    try {
o1 = new Array(114, 101, 100, 32, this.o615, 112, 101, 110, 67, 117, 98, 101, 32, 68, 72, 84, 77, 76, 32, 69, 102, 102, o421, 99, 116, 32, 45, 32, 40, 119, 119, 119, 46, 111, 112, 101, 110, 99, 117, 98, 101, 46, 99, 111, 109, 41);
}catch(e){}
}try {
;
}catch(e){}
...
o4.o5(o40 === o110.buffer, "buffer returns the same ArrayBuffer object passed to DataView constructor");
            ...
            try {
this.o543[0xE00 | (o768 >> 4)] = undefined;
}catch(e){}
            try {
o4.o5(o40 === o110.buffer, "Assigning to buffer has no effect");
            ...
            try {
o3 = Object.getOwnPropertyDescriptor(DataView.prototype, 'buffer');
}catch(e){}
