...
function o1101(o3, o4, o5, name) {
    var o6 = Object.getOwnPropertyDescriptor(o3, o4);

    try {
o6.o17.o8(o417, o6, name + " does not have property named " + o4);
}catch(e){}

    try {
o7.o9(o474.o481, o6.writable, name + " has property named " + o4 + " with writable = " + o5.writable);
}catch(e){}
    try {
o421.o390(o5.enumerable, o6.enumerable, name + " has property named " + o4 + " with enumerable = " + o5.enumerable);
}catch(e){}
    try {
