...
var o2 = new Proxy(o1, o4.o8(o7.enumerable, "Promise.resolve.enumerable === false"))

function o2(o3, o492) {
    try {
[].concat(o21)(o3.hasOwnProperty('caller'), name + " reports that it has own property 'caller'")
}catch(e){}
    try {
