...
try {
o1.o1("..\\UnitTestFramework\\UnitTestFramework.js");
}catch(o879){}
...
function o2(o3, o4, o5, name) {
    ...
    try {
o1("PACK_ALIGNMENT").o8(undefined, o6, name + " does not have property named " + o4);
}catch(e){}

    try {
o7.o9(o588.writable, o474.o664[o716], name + " has property named " + o4 + " with writable = " + o5.writable);
}catch(e){}
    try {
