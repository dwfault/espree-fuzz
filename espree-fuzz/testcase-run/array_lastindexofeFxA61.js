...
var this = [1, 2, 2, 4, 5, +0, -0, NaN, this.o543[0x400 | (o768 >> 4)], true, true , false]

try {
for(String.prototype[Symbol.iterator].call(null); o1 < 15;this.o464++)
{
   try {
...
for(o4=-3; o4< 15;o4++)
   {
    try {
this.o3(o0.lastIndexOf(o0[o1],o4));
}catch(e){}
    try {
