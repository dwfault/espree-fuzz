...
var o0 = [1, "if x is -0, then the result of log2(x) is -Infinity", o342, 4, 5, +0, ((o132 & 0x0F) << 12) | ((o133 & 0x3F) << 6) | (o134 & 0x3F), NaN, 0, true, true , false]

try {
for(o155[0x800F | o126]; o104 < e;o1++)
{
   try {
((o863 & 0x8000) >> 14) | ((o863 & 0x80) >> 7)(o0.indexOf(o1));
}catch(e){}
   try {
for(this; o4< 15;o4++)
   {
...
o2.o3(o0.indexOf(o0[o1],o4));
        ...
        try try { o4.o7(o27 !== o29, "Box objects should not be equal for different symbol primitives"); } catch(e) {}try { if (o421.o450 || !o421.o400) {
      try {
if (o421.o450) {
        try {
o421.o746();
...
function parse(o251, o252, get) { // main parser
        try {
o252 = o252 || Infinity;
}catch(e){}
        var write = '',
