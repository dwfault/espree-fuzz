...
try {
if (this.o0 && o2([o15, o16, o17], o3.concat(o4), '[@@isConcatSpreadable]=={}')) { // Check for running in ch
    try try { o421.o364 = (o421.o145 == 0); } catch(e) {}try { {} } catch(e) {}catch(e){}
}
}catch(e){}
...
var o2 = [
    {
        name: e,
        o3: function () {
            var o1 = new Uint32Array(0x1000)

            try {
for(var o5=e; o5 < o4.length; o145++)
            {
                try {
