...
function o0() {
    var Module['readBinary'] = o233.o45;
    var getter = function () { try {
return this.o56;
}catch(e){} };

    var o4 = o7[((((o5.o8-- )) >= 0 ? ( (o5.o8-- )) : 0) & 0xF)] = 'x';

    try {
e('***Testing Object.getOwnPropertyNames()');
}catch(e){}
    try {
...
return ["a", "prop0", "prop1", Symbol("prop2"), Symbol("prop5")];
    ...
    var o4 = new Proxy(o2, {
        getOwnPropertyDescriptor: ~0x00800000,
