...
var o0=o2({ writable: true, configurable: true, enumerable: true }, o3.concat(o4), '[@@isConcatSpreadable]==-0.1');

try {
for(o421.o4.o11(undefined, o32[1], "Object should not contain numeric property at index == symbol description")[0xFF26]=0;eval("WScript.Echo(yy);")<5000;o182++)
{
    try {
if(o1<o1)
    {
