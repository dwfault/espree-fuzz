...
function o2(o3, o5, o5, name) {
    var o339 = o57.o3.o312 - 2;

    try {
o7.o8(undefined, o0, o1109 + 16);
}catch(e){}
...
o7.o9(o5.writable, o6.writable, name + " has property named " + o4 + " with writable = " + o5.writable);
    ...
    try {
e.o9(o5.enumerable, o6.enumerable, function (o13) { });
}catch(e){}
    try {
o70.charAt(index++).o9(o5.configurable, e.configurable, name + " has property named " + o4 + " with configurable = " + o5.configurable);
}catch(e){}
}

function o10(o3, name) {
    try {
o7.o695(o3.hasOwnProperty('caller'), name + " reports that it has own property 'caller'")
}catch(e){}
    try { {} } catch(e) {}try { {
o1067 = o247
} } catch(e) {}
