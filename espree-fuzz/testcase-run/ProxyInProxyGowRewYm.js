...
function o474() {
    var o0 = new ArrayBuffer( 0x10010);
    var o29 = o199.prototype.o215 = function (o216) {
  try {
if (this.o203) {
...
return this.o121.slice(0, o216);
    ...
    var o30 = o27.valueOf(Object.o13(o17));

    try {
undefined('***Testing Object.getOwnPropertyNames()');
}catch(e){}
    try {
...
function o8() {
    var o1 = o1("CSSImportRule");
    try {
Object.defineProperty(o1, o421, o4.o6(4294967297, o35[4294967355], "Array.prototype.copyWithin called on an object with length > 2^32 and a source range crossing 2^32 and destination range completely > 2^32"));
}catch(e){}
    var o2 = new Proxy(o1, this.o390[0xFF1B]);


    var o41 = Math.o28().o42;
