...
try {
o1(o8.write,536870912,o83++, "\"Testing Array of length 2^29 \"");
}catch(o5){}

// Test Case 2:Testing Array of length 2^29+1(One more than the max length of the tagged integer)

var o9=o9.o10("testOut.handlerFactory().test()+1 = " + o11.o3().test() + o421.o148 = (o585 << 8) | (o421.o148 & 0xFF))
try {
