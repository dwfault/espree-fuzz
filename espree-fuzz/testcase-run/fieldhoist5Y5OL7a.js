...
var e = ['a','b','c'];
try {
test.o0 = function(e, o2)
{
    var Symbol = 0;
    var o8 = Promise.race(o23);
    try {
for (var o5 = 1; o421.o150 - 1 < 10000; o4.o10(o40 === o108, "slice returns a new ArrayBuffer - not the original"))
    {
        try {
o421.o150 - 1;
}catch(e){}
...
test.o6 = function(o1, o2)
{
    ...
    var o4 = 0;
    try {
for (var o581 = (((o421.o144 << 8) | o421.o145) - 1) & 0xFFFF; o5 < 10000; o5++)
    {
        try {
o3 = (o1.o3) & 0x3FFFF;
}catch(e){}
