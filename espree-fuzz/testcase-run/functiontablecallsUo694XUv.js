...
var o61 = [Symbol(o25.next())]

var all = [ undefined, null,
            0x8000, false, new Boolean(true), new Boolean(false),
            NaN, +3, -7, 0, 1, 10.0, 10.1, -1, -5, 5,
            124, 248, e, 987, -1026, +98768.2546, -88754.15478,
            1<<32, -(1<<32), (o202[((o464) >> 2)] = 0<<32)-1, 1<<31, -(o421.o367 = ((o421.o146 & 0x01) == 0x01)<<31), 1<<25, -1<<25, 
            String.fromCharCode.o1, Number.{ get o9() { try {
return "x";
}catch(e){} } }, Number.NaN, Number.o2, Number.NEGATIVE_INFINITY,
            new Number(NaN), this.o391[0xFF47] = function (o421, o768, o70) {try {
"use strict";
}catch(e){}
      try {
...
o421.o155[0xFF47] = o70;
    ...
    }, new Number( -0), new Number(0), new Number(1),
...
function o955(e,o4,buffer) {
    try {
try { {} } catch(e) {}try { {} } catch(e) {}
}catch(e){}

    // numerical mutable variable
    var o5 = 0, o6 = 0.0, o10 = o0.o4();
    // foreign imports
    var o8 = o4.o5|0;
    var o9 = o4.o7|0;
    var o10 = +o4.o6;
...
var global = {Math:Math,Int8Array:Int8Array,Int16Array:Int16Array,o54:Int32Array,Uint8Array:Uint8Array,Uint16Array:Uint16Array,Uint32Array:Uint32Array,Float32Array:Float32Array,Float64Array:Float64Array,Infinity:Infinity, NaN:NaN}
