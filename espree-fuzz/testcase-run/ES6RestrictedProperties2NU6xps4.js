...
var o2 = new Proxy(o1, this.o565[o810++])

function o10(o3, e) {
    try {
function (length, o940, o941) {try {
"use strict";
}catch(e){}
  try {
try {
...
}(o3.hasOwnProperty('caller'), name + " reports that it has own property 'caller'")
}catch(e){}
    try {
o7.o11(o3.hasOwnProperty('arguments'), name + o360.prototype.o767)
}catch(e){}

    var o12 = Object.getOwnPropertyNames(o839);
    try {
