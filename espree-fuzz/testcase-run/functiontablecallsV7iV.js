...
var all = [ undefined, null,
            true, false, { value: 10, writable: 5, enumerable: true }, new Boolean(false),
            NaN, +0, -0, 0, 1, 10.0, 10.1, -1, -5, 5,
            124, 248, 654, 987, -1026, +98768.2546, -88754.15478,
            1<<32, -(1<<32), (0<<32)-1, 1<<31, o5.o6(o0), 1<<25, -1<<25, 
...
"use asm";
    ...
    var o5 = 0, this.o552[o851 | o847[o842 | 1]] = 0.0, o7 = -5;
    // foreign imports
    var o8 = function() {
            try {
...
o4.o7(o31.valueOf() === o31.valueOf(), "Autoboxing for valueOf()");
    ...
    var o15 = o16.Infinity, o16 = stdlib.NaN;
