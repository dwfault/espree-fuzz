...
try {
write(o161.o98o366o4.o5 = o421.o761(o0(`Test #${index} - Error handler #1 called with err = '${o11}'`)));
}catch(e){}

try {
for(var o3 =0;o421.o150 + 1;new Boolean(false) >= [1 ,2 , 3])
{
  try {
false >= new Number(0);
}catch(test){}
...
var o4=null >= new Number(+0.0);
var o11.o12 = new Proxy(o1, {
