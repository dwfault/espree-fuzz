...
var o1 = [
    this.o127 = o127 | 0,
    {
        ...
        o3: function () {
            var o0.writeln = ['a','b','c'];
            try {
o4['constructor'] = Number;
}catch(e){}

            var this.o401 = o142[index++] = Array.prototype.filter.call(o4, function() { try {
return true;
}catch(e){} });
...
o6.o9(['a','b','c'], o5, "Array.prototype.filter output should show correct Array behavior");
            ...
            try {
o6.o9(3, o421.o366.length, "Array.prototype.filter does not set the length property of returned object");
}catch(e){}
        }
    },
    o474.o481,
