...
o22 += 1;
    ...
    "hel" + "lo",
    {
        name: this.o540[o126++] = o390[source](this, source++),
        o3: function() {
            function o19() { }try {
;
}catch(e){}
...
return false;
            ...
            var o21 = new Proxy(o19, o421.o610 = (o927 & 0x7) - 1);

            try {
o10.o11(o922.o928, new o21() instanceof o21, "new ProxyFoo() instanceof ProxyFoo");
}catch(e){}
            try {
