...
try {
if (o4.o11(delete Array.prototype[2], arguments.length, "%TypedArray%.from called with a mapping function, only 2 arguments should be passed to the map function"))
...
[
    o7.o8,
    o1.length & (o14 ? (o1.o10 = { valueOf: function () { try {
