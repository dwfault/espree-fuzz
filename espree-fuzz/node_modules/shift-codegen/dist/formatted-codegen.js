  ...
  _createClass(ExtensibleCodeGen, [{
    ...
    value: function reduceCallExpression(node, _ref18) {
      ...
      var parenthizedArgs = args.map(function (a, i) {
        return _this5.p(node.arguments[i], _coderep.Precedence.Assignment, a);
      });
...
var Linebreak = function (_CodeRep) {
  ...
  function Linebreak() {
    ...
    var _this7 = _possibleConstructorReturn(this, (Linebreak.__proto__ || Object.getPrototypeOf(Linebreak)).call(this));

    _this7.indentation = 0;
    return _this7;
  }
