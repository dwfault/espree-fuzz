...
var o12 = [
    ...
    },
    {
        ...
        o13: function () {
            o6.o7(function () { Array.prototype.find.call(); }, o8, "find throws TypeError if it is given no arguments", "Array.prototype.find: 'this' is null or undefined");
            o6.o7(function () { Array.prototype.find.call(undefined); }, o8, "find throws TypeError if its this argument is undefined", "Array.prototype.find: 'this' is null or undefined");
            o6.o7(function () { Array.prototype.find.call(undefined, function () { return true; }, {}); }, o8, "find throws TypeError if its this argument is undefined even if given further arguments", "Array.prototype.find: 'this' is null or undefined");
            o6.o7(function () { Array.prototype.find.call(null); }, o8, "find throws TypeError if its this argument is null", "Array.prototype.find: 'this' is null or undefined");
            o6.o7(function () { Array.prototype.find.call(null, function () { return true; }, {}); }, o8, "find throws TypeError if its this argument is null even if given further arguments", "Array.prototype.find: 'this' is null or undefined");

            var o15 = [ 1, 2, 3 ];

            // Test missing/invalid predicate argument
            o6.o7(function () { o15.find(); }, o8, "find throws TypeError if it is given no predicate argument", "Array.prototype.find: argument is not a Function object");
            o6.o7(function () { o15.find({}); }, o8, "find throws TypeError if it is given a non-Function object predicate argument", "Array.prototype.find: argument is not a Function object");
            ...
            o6.o7(function () { o16.find(); }, Error, "find gets length property, calling getter method, before checking for a valid predicate function argument", "getter called");

            // Test simple predicates matching each element
            o6.o17(        1, o15.find(function (o18, o19, o20) { return true; }), "Simple predicate always returns true, should find first item");
            o6.o17(        1, o15.find(function (o18, o19, o20) { if (o19 >= 1) { o6.o21("shouldn't visit index > 0"); } return o18 === 1; }), "Simple predicate matching first element, should find first element");
            o6.o17(        2, o15.find(function (o18, o19, o20) { if (o19 >= 2) { o6.o21("shouldn't visit index > 1"); } return o18 === 2; }), "Simple predicate matching second element, should find second element");
            o6.o17(        3, o15.find(function (o18, o19, o20) { if (o19 >= 3) { o6.o21("shouldn't visit index > 2"); } return o18 === 3; }), "Simple predicate matching third element, should find third element");
            o6.o17(undefined, o15.find(function (o18, o19, o20) { if (o19 >= 3) { o6.o21("shouldn't visit index > 2"); } return o18 === 4; }), "Simple predicate matching non-existent element, should not find any element");
            o6.o17(        2, o15.find(function (o18, o19, o20) { if (o19 >= 2) { o6.o21("shouldn't visit index > 1"); } return o18 === 2 || o18 === 3; }), "Simple predicate matching two elements, second and third, should find first of them, i.e. the second element");

            // Test adding elements in predicate function
            o6.o17(undefined, o15.find(function (o18, o19, o20) { if (o19 >= 3) { o6.o21("shouldn't visit index > 2 (initial array length"); } o20.push(o18 + 3); return false; }), "Elements added after find has started shouldn't be included in the search");
            ...
            o6.o17(undefined, o15.find(function (o18, o19, o20) { delete o20[o19]; return false; }), "Elements deleted after being visited has no effect on the search");
            ...
            var o22 = { };
            o6.o17(undefined, o15.find(function (o18, o19, o20) { if (this !== o22) { o6.o21("this is not what was passed to second parameter of find()"); } return false; }, o22), "Argument passed as the optional second parameter of find should become the this value in the predicate");
            ...
            o6.o17(undefined, Array.prototype.find.call(o15, function (o18, o19, o20) {o6.o21("shouldn't visit any element when length is less than zero"); return true;}), "find should use ToLength function that clamps length between 0 and pow(2,53)-1");
        }
    },
    {
        ...
        o13: function () {
            o6.o7(function () { Array.prototype.findIndex.call(); }, o8, "findIndex throws TypeError if it is given no arguments", "Array.prototype.findIndex: 'this' is null or undefined");
            o6.o7(function () { Array.prototype.findIndex.call(undefined); }, o8, "findIndex throws TypeError if its this argument is undefined", "Array.prototype.findIndex: 'this' is null or undefined");
            o6.o7(function () { Array.prototype.findIndex.call(undefined, function () { return true; }, {}); }, o8, "findIndex throws TypeError if its this argument is undefined even if given further arguments", "Array.prototype.findIndex: 'this' is null or undefined");
            o6.o7(function () { Array.prototype.findIndex.call(null); }, o8, "findIndex throws TypeError if its this argument is null", "Array.prototype.findIndex: 'this' is null or undefined");
            o6.o7(function () { Array.prototype.findIndex.call(null, function () { return true; }, {}); }, o8, "findIndex throws TypeError if its this argument is null even if given further arguments", "Array.prototype.findIndex: 'this' is null or undefined");

            var o15 = [ 1, 2, 3 ];

            // Test missing/invalid predicate argument
            o6.o7(function () { o15.findIndex(); }, o8, "findIndex throws TypeError if it is given no predicate argument", "Array.prototype.findIndex: argument is not a Function object");
            o6.o7(function () { o15.findIndex({}); }, o8, "findIndex throws TypeError if it is given a non-Function object predicate argument", "Array.prototype.findIndex: argument is not a Function object");
            ...
            o6.o7(function () { o16.findIndex(); }, Error, "findIndex gets length property, calling getter method, before checking for a valid predicate function argument", "getter called");

            // Test simple predicates matching each element
            o6.o17( 0, o15.findIndex(function (o18, o19, o20) { return true; }), "Simple predicate always returns true, should find first item");
            o6.o17( 0, o15.findIndex(function (o18, o19, o20) { if (o19 >= 1) { o6.o21("shouldn't visit index > 0"); } return o18 === 1; }), "Simple predicate matching first element, should find first element");
            o6.o17( 1, o15.findIndex(function (o18, o19, o20) { if (o19 >= 2) { o6.o21("shouldn't visit index > 1"); } return o18 === 2; }), "Simple predicate matching second element, should find second element");
            o6.o17( 2, o15.findIndex(function (o18, o19, o20) { if (o19 >= 3) { o6.o21("shouldn't visit index > 2"); } return o18 === 3; }), "Simple predicate matching third element, should find third element");
            o6.o17(-1, o15.findIndex(function (o18, o19, o20) { if (o19 >= 3) { o6.o21("shouldn't visit index > 2"); } return o18 === 4; }), "Simple predicate matching non-existent element, should not find any element");
            o6.o17( 1, o15.findIndex(function (o18, o19, o20) { if (o19 >= 2) { o6.o21("shouldn't visit index > 1"); } return o18 === 2 || o18 === 3; }), "Simple predicate matching two elements, second and third, should find first of them, i.e. the second element");

            // Test adding elements in predicate function
            o6.o17(-1, o15.findIndex(function (o18, o19, o20) { if (o19 >= 3) { o6.o21("shouldn't visit index > 2 (initial array length"); } o20.push(o18 + 3); return false; }), "Elements added after findIndex has started shouldn't be included in the search");
            o6.o17([ 1, 2, 3, 4, 5, 6 ], o15, "Three more elements should be added to end of arr");
            ...
            // Test deleting elements in predicate function that have already been visited
            o6.o17(       -1, o15.findIndex(function (o18, o19, o20) { delete o20[o19]; return false; }), "Elements deleted after being visited has no effect on the search");
            o6.o17(undefined, o15[0], "All elements should be deleted [0]");
            o6.o17(undefined, o15[1], "All elements should be deleted [1]");
            o6.o17(undefined, o15[2], "All elements should be deleted [2]");
            o6.o17(undefined, o15[3], "All elements should be deleted [3]");
            ...
            // Test thisArg argument
            var o22 = { };
            o6.o17(-1, o15.findIndex(function (o18, o19, o20) { if (this !== o22) { o6.o21("this is not what was passed to second parameter of findIndex()"); } return false; }, o22), "Argument passed as the optional second parameter of findIndex should become the this value in the predicate");

            // Test and ensure Array.prototype.findIndex calls ToLength
            //    checks lower bound (negative -> zero)
            //    upper bound ( pow(2,53)-1 ) cannot be tested in reasonable time
            var o15 = { '0': 1, '1': 2, '2': 3, length: -3 };
            o6.o17(-1, Array.prototype.findIndex.call(o15, function (o18, o19, o20) {o6.o21("shouldn't visit any element when length is less than zero"); return true;}), "findIndex should use ToLength function that clamps length between 0 and pow(2,53)-1");
        }
    },
    {
        ...
        o13: function () {
            ...
            o15.find(function () { o23++; return false; });
            ...
            o15.findIndex(function () { o23++; return false; });
            ...
            Array.prototype.find.call(o15, function () { o23++; return false; });
            ...
            Array.prototype.findIndex.call(o15, function () { o23++; return false; });
    ...
    },
    {
        ...
        o13: function () {
            o6.o7(function () { String.prototype.repeat.call(); }, o8, "repeat throws TypeError if it is given no arguments", "String.prototype.repeat: 'this' is null or undefined");
            o6.o7(function () { String.prototype.repeat.call(undefined); }, o8, "repeat throws TypeError if its this argument is undefined", "String.prototype.repeat: 'this' is null or undefined");
            o6.o7(function () { String.prototype.repeat.call(undefined, "", 0); }, o8, "repeat throws TypeError if its this argument is undefined even if given further arguments", "String.prototype.repeat: 'this' is null or undefined");
            o6.o7(function () { String.prototype.repeat.call(null); }, o8, "repeat throws TypeError if its this argument is null", "String.prototype.repeat: 'this' is null or undefined");
            o6.o7(function () { String.prototype.repeat.call(null, "", 0); }, o8, "repeat throws TypeError if its this argument is null even if given further arguments", "String.prototype.repeat: 'this' is null or undefined");
            ...
            o6.o7(function () { o24.repeat(-1); }, o25, "negative repeat counts are out of range", "String.prototype.repeat: argument out of range");
            o6.o7(function () { o24.repeat(-Infinity); }, o25, "negative infinite repeat count is out of range", "String.prototype.repeat: argument out of range");
            o6.o7(function () { o24.repeat(Infinity); }, o25, "infinite repeat count is out of range", "String.prototype.repeat: argument out of range");
    ...
    },
    {
        ...
        o13: function () {
            o6.o7(function () { String.prototype.startsWith.call(); }, o8, "startsWith throws TypeError if it is given no arguments", "String.prototype.startsWith: 'this' is null or undefined");
            o6.o7(function () { String.prototype.startsWith.call(undefined); }, o8, "startsWith throws TypeError if its this argument is undefined", "String.prototype.startsWith: 'this' is null or undefined");
            o6.o7(function () { String.prototype.startsWith.call(undefined, "", 0); }, o8, "startsWith throws TypeError if its this argument is undefined even if given further arguments", "String.prototype.startsWith: 'this' is null or undefined");
            o6.o7(function () { String.prototype.startsWith.call(null); }, o8, "startsWith throws TypeError if its this argument is null", "String.prototype.startsWith: 'this' is null or undefined");
            o6.o7(function () { String.prototype.startsWith.call(null, "", 0); }, o8, "startsWith throws TypeError if its this argument is null even if given further arguments", "String.prototype.startsWith: 'this' is null or undefined");
    ...
    },
    {
        ...
        o13: function () {
            o6.o7(function () { String.prototype.endsWith.call(); }, o8, "endsWith throws TypeError if it is given no arguments", "String.prototype.endsWith: 'this' is null or undefined");
            o6.o7(function () { String.prototype.endsWith.call(undefined); }, o8, "endsWith throws TypeError if its this argument is undefined", "String.prototype.endsWith: 'this' is null or undefined");
            o6.o7(function () { String.prototype.endsWith.call(undefined, "", 0); }, o8, "endsWith throws TypeError if its this argument is undefined even if given further arguments", "String.prototype.endsWith: 'this' is null or undefined");
            o6.o7(function () { String.prototype.endsWith.call(null); }, o8, "endsWith throws TypeError if its this argument is null", "String.prototype.endsWith: 'this' is null or undefined");
            o6.o7(function () { String.prototype.endsWith.call(null, "", 0); }, o8, "endsWith throws TypeError if its this argument is null even if given further arguments", "String.prototype.endsWith: 'this' is null or undefined");
    ...
    },
    {
        ...
        o13: function () {
            o6.o7(function () { String.prototype.includes.call(); }, o8, "includes throws TypeError if it is given no arguments", "String.prototype.includes: 'this' is null or undefined");
            o6.o7(function () { String.prototype.includes.call(undefined); }, o8, "includes throws TypeError if its this argument is undefined", "String.prototype.includes: 'this' is null or undefined");
            o6.o7(function () { String.prototype.includes.call(undefined, "", 0); }, o8, "includes throws TypeError if its this argument is undefined even if given further arguments", "String.prototype.includes: 'this' is null or undefined");
            o6.o7(function () { String.prototype.includes.call(null); }, o8, "includes throws TypeError if its this argument is null", "String.prototype.includes: 'this' is null or undefined");
            o6.o7(function () { String.prototype.includes.call(null, "", 0); }, o8, "includes throws TypeError if its this argument is null even if given further arguments", "String.prototype.includes: 'this' is null or undefined");
